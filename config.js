...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://offblood_db_user:bloodmd@cluster0.xrqkzwg.mongodb.net/?appName=Cluster0',
    
    // ===========================================================
    // 2. INFORMATIONS DU BOT
    // ===========================================================
    PREFIX: process.env.PREFIX || '.',
    OWNER_NUMBER: process.env.OWNER_NUMBER || '', // Mettez votre numéro ici
    BOT_NAME: "BLOOD-MD-MINI",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʙʟᴏᴏᴅ-ᴍᴅ',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://files.catbox.moe/uzi4rn.png',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb867uIKwqSWDtOS2X3N',
